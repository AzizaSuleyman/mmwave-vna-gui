...
class VNA(tk.Tk):
    def __init__(self, tasks=None):
        ...
        # Frame for the plots
        self.plot_frame_IQ = tk.Frame(self, width=1800, height=600, bg="white")
        self.plot_frame_IQ.pack(side = tk.TOP,fill=tk.X, expand=False)
        
        # Frame for the plots
        self.plot_frame_mag = tk.Frame(self, width=1800, height=600, bg="white")
...
# =============================================================================
        ...
        self.fig_I = figure.Figure(figsize=(10, 5))
        ...
        self.ax2_I = self.ax1_I.twinx()
         ...
         # Create figure for plotting
        self.fig_Q = figure.Figure(figsize=(10, 5))
        ...
        # Create figure for plotting
        self.fig_mag = figure.Figure(figsize=(10, 5))
        ...
        # Create figure for plotting
        self.fig_phase = figure.Figure(figsize=(10, 5))
    ...
    def update_SC(self, event=None):
        ...
        #self.freq_step_sc = round((self.freq_span_mw)/self.N_POINTS)
        scan_time = 500*self.dwell_time*self.N_POINTS # time in us (5s)
        #SC_VNA.update_scan( self.freq_center_sc, self.freq_span_sc,  self.freq_step_sc, avg_n)
    ...
    def measure(self):
        ...
        for i in range(1, self.avg.get()+1):    
            #self.rp.trigger_out()
            try:
                #self.IQ = self.rp.measure_all()
                print(i)
            except:
                pass
            self.I = self.I + self.IQ[0]
            self.Q = self.Q + self.IQ[1]
        ...
        color = 'tab:red'
        self.ax1_mag.clear()
        self.ax1_mag.set_ylabel('Mag Data S11', color=color)
